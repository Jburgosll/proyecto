class Ciclos{
    nombre(){
        console.warn(`presentar un nombre 5 veces`);
        let nombre="juan",c=1,v=5
        for(c=1;c<=v;c++){
            console.log(`${nombre}`)
        }
    }
    ...
    exponente(){
        ...
        let num=4,exponente=6,c=1,acu=num
        console.log(` NUMERO:${num}  EXPONENTE:${exponente}`);
        for(c=1;c<exponente;c++){
            acu=acu*num
        }
    ...
    NumeroPrimo(){
        ...
        let num=10,divisor=2,primo=1,r
        console.log(` NUMERO:${num}`);
